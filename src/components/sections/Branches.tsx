...
import { MapPin, Phone, Clock, ShoppingBag, Store, MessageCircle } from "lucide-react";
import { BRANCHES_CONTENT } from "@/constants/content";
import { SectionHeader } from "@/components/ui";
import { AnimateInView } from "@/components/ui/AnimateInView";

function getBranchIcon(id: string) {
  switch (id) {
    case "shopee-official":
    case "tiktok-shop":
      return <ShoppingBag size={20} />;
    case "reseller-wa":
      return <MessageCircle size={20} />;
    case "tokopedia-bandung":
    case "tokopedia-bogor":
    case "tokopedia-bintaro":
